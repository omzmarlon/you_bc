export const PRIMARY_RED = '#f65314';
export const PRIMARY_BLUE = '#00a1f1';
export const PRIMARY_YELLOW = '#ffbb00';
export const PRIMARY_GREEN = '#09b83e';
export const PRIMARY_WHITE = '#ffffff';

//TODO: change these later according to design
export const SECONDARY_RED = '#ffc3b6';
