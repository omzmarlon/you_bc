...
export const RECEIVE_MAJORS_OPTIONS = 'RECEIVE_MAJORS_OPTIONS';
export const RECEIVE_COURSES_OPTIONS = 'RECEIVE_COURSES_OPTIONS';
export const RECEIVE_CLASSMATES_TAGS = 'RECEIVE_CLASSMATES_TAGS';
export const RECEIVE_LOCATIONS_OPTIONS = 'RECEIVE_LOCATIONS_OPTIONS';
export const RECEIVE_HOMETOWNS_OPTIONS = 'RECEIVE_HOMETOWNS_OPTIONS';
export const RECEIVE_ROOMMATE_TAGS = 'RECEIVE_ROOMMATE_TAGS';
export const RECEIVE_FACULTIES_OPTIONS = 'RECEIVE_FACULTIES_OPTIONS';
export const RECEIVE_RELATIONSHIP_STATUSES_OPTIONS = 'RECEIVE_RELATIONSHIP_STATUSES_OPTIONS';
export const RECEIVE_FRIENDS_TAGS = 'RECEIVE_FRIENDS_TAGS';
// updating
