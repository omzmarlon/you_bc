...
public class ClassmatesTagsRecord extends UpdatableRecordImpl<ClassmatesTagsRecord> implements Record2<Integer, String> {
    ...
    private static final long serialVersionUID = 1626353940;

    /**
     * Setter for <code>poke_you_bc.classmates_tags.tag_id</code>.
     */
    public ClassmatesTagsRecord setTagId(Integer value) {
        set(0, value);
        return this;
    }

    /**
     * Getter for <code>poke_you_bc.classmates_tags.tag_id</code>.
     */
    ...
    public Field<Integer> field1() {
        return ClassmatesTags.CLASSMATES_TAGS.TAG_ID;
    }
     ...
     */
    public ClassmatesTagsRecord(Integer tagId, String tag) {
        super(ClassmatesTags.CLASSMATES_TAGS);
