...
public class FriendsTagsRecord extends UpdatableRecordImpl<FriendsTagsRecord> implements Record2<Integer, String> {
    ...
    private static final long serialVersionUID = -923538766;

    /**
     * Setter for <code>poke_you_bc.friends_tags.tag_id</code>.
     */
    public FriendsTagsRecord setTagId(Integer value) {
        set(0, value);
        return this;
    }

    /**
     * Getter for <code>poke_you_bc.friends_tags.tag_id</code>.
     */
    ...
    public Field<Integer> field1() {
        return FriendsTags.FRIENDS_TAGS.TAG_ID;
    }
     ...
     */
    public FriendsTagsRecord(Integer tagId, String tag) {
        super(FriendsTags.FRIENDS_TAGS);
