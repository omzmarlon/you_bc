...
public class FacultiesRecord extends UpdatableRecordImpl<FacultiesRecord> implements Record2<Integer, String> {
    ...
    private static final long serialVersionUID = -756262036;

    /**
     * Setter for <code>poke_you_bc.faculties.faculty_id</code>.
     */
    public FacultiesRecord setFacultyId(Integer value) {
        set(0, value);
        return this;
    }

    /**
     * Getter for <code>poke_you_bc.faculties.faculty_id</code>.
     */
    ...
    public Field<Integer> field1() {
        return Faculties.FACULTIES.FACULTY_ID;
    }
     ...
     */
    public FacultiesRecord(Integer facultyId, String faculty) {
        super(Faculties.FACULTIES);
