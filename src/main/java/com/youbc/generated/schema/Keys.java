...
public class Keys {
    ...
    private static class Identities0 extends AbstractKeys {
        public static Identity<ClassmatesCoursesRecord, Integer> IDENTITY_CLASSMATES_COURSES = createIdentity(ClassmatesCourses.CLASSMATES_COURSES, ClassmatesCourses.CLASSMATES_COURSES.COURSE_ID);
        public static Identity<ClassmatesMajorRecord, Integer> IDENTITY_CLASSMATES_MAJOR = createIdentity(ClassmatesMajor.CLASSMATES_MAJOR, ClassmatesMajor.CLASSMATES_MAJOR.MAJOR_ID);
        public static Identity<ClassmatesTagsRecord, Integer> IDENTITY_CLASSMATES_TAGS = createIdentity(ClassmatesTags.CLASSMATES_TAGS, ClassmatesTags.CLASSMATES_TAGS.TAG_ID);
        public static Identity<FacultiesRecord, Integer> IDENTITY_FACULTIES = createIdentity(Faculties.FACULTIES, Faculties.FACULTIES.FACULTY_ID);
        public static Identity<FriendsTagsRecord, Integer> IDENTITY_FRIENDS_TAGS = createIdentity(FriendsTags.FRIENDS_TAGS, FriendsTags.FRIENDS_TAGS.TAG_ID);
        ...
        public static Identity<RelationshipStatusRecord, Integer> IDENTITY_RELATIONSHIP_STATUS = createIdentity(RelationshipStatus.RELATIONSHIP_STATUS, RelationshipStatus.RELATIONSHIP_STATUS.RELATIONSHIP_ID);
        public static Identity<RoommatesHometownRecord, Integer> IDENTITY_ROOMMATES_HOMETOWN = createIdentity(RoommatesHometown.ROOMMATES_HOMETOWN, RoommatesHometown.ROOMMATES_HOMETOWN.HOMETOWN_ID);
        public static Identity<RoommatesLocationsRecord, Integer> IDENTITY_ROOMMATES_LOCATIONS = createIdentity(RoommatesLocations.ROOMMATES_LOCATIONS, RoommatesLocations.ROOMMATES_LOCATIONS.LOCATION_ID);
        public static Identity<RoommatesTagsRecord, Integer> IDENTITY_ROOMMATES_TAGS = createIdentity(RoommatesTags.ROOMMATES_TAGS, RoommatesTags.ROOMMATES_TAGS.TAG_ID);
    }

    private static class UniqueKeys0 extends AbstractKeys {
        public static final UniqueKey<ClassmatesCoursesRecord> KEY_CLASSMATES_COURSES_PRIMARY = createUniqueKey(ClassmatesCourses.CLASSMATES_COURSES, "KEY_classmates_courses_PRIMARY", ClassmatesCourses.CLASSMATES_COURSES.COURSE_ID);
        ...
        public static final UniqueKey<ClassmatesMajorRecord> KEY_CLASSMATES_MAJOR_PRIMARY = createUniqueKey(ClassmatesMajor.CLASSMATES_MAJOR, "KEY_classmates_major_PRIMARY", ClassmatesMajor.CLASSMATES_MAJOR.MAJOR_ID);
        ...
        public static final UniqueKey<ClassmatesProfileCoursesRecord> KEY_CLASSMATES_PROFILE_COURSES_PRIMARY = createUniqueKey(ClassmatesProfileCourses.CLASSMATES_PROFILE_COURSES, "KEY_classmates_profile_courses_PRIMARY", ClassmatesProfileCourses.CLASSMATES_PROFILE_COURSES.USER_ID, ClassmatesProfileCourses.CLASSMATES_PROFILE_COURSES.COURSE_ID);
        public static final UniqueKey<ClassmatesProfileTagsRecord> KEY_CLASSMATES_PROFILE_TAGS_PRIMARY = createUniqueKey(ClassmatesProfileTags.CLASSMATES_PROFILE_TAGS, "KEY_classmates_profile_tags_PRIMARY", ClassmatesProfileTags.CLASSMATES_PROFILE_TAGS.USER_ID, ClassmatesProfileTags.CLASSMATES_PROFILE_TAGS.TAG_ID);
        public static final UniqueKey<ClassmatesTagsRecord> KEY_CLASSMATES_TAGS_PRIMARY = createUniqueKey(ClassmatesTags.CLASSMATES_TAGS, "KEY_classmates_tags_PRIMARY", ClassmatesTags.CLASSMATES_TAGS.TAG_ID);
        public static final UniqueKey<FacultiesRecord> KEY_FACULTIES_PRIMARY = createUniqueKey(Faculties.FACULTIES, "KEY_faculties_PRIMARY", Faculties.FACULTIES.FACULTY_ID);
        ...
        public static final UniqueKey<RoommatesLocationsRecord> KEY_ROOMMATES_LOCATIONS_PRIMARY = createUniqueKey(RoommatesLocations.ROOMMATES_LOCATIONS, "KEY_roommates_locations_PRIMARY", RoommatesLocations.ROOMMATES_LOCATIONS.LOCATION_ID);
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        ...
        public static final ForeignKey<ClassmatesProfileRecord, ClassmatesMajorRecord> CLASSMATES_PROFILE_IBFK_2 = createForeignKey(com.youbc.generated.schema.Keys.KEY_CLASSMATES_MAJOR_PRIMARY, ClassmatesProfile.CLASSMATES_PROFILE, "classmates_profile_ibfk_2", ClassmatesProfile.CLASSMATES_PROFILE.MARJOR_ID);
        ...
        public static final ForeignKey<ClassmatesProfileCoursesRecord, ClassmatesCoursesRecord> CLASSMATES_PROFILE_COURSES_IBFK_2 = createForeignKey(com.youbc.generated.schema.Keys.KEY_CLASSMATES_COURSES_PRIMARY, ClassmatesProfileCourses.CLASSMATES_PROFILE_COURSES, "classmates_profile_courses_ibfk_2", ClassmatesProfileCourses.CLASSMATES_PROFILE_COURSES.COURSE_ID);
        ...
        public static final ForeignKey<FriendsProfileRecord, FacultiesRecord> FRIENDS_PROFILE_IBFK_2 = createForeignKey(com.youbc.generated.schema.Keys.KEY_FACULTIES_PRIMARY, FriendsProfile.FRIENDS_PROFILE, "friends_profile_ibfk_2", FriendsProfile.FRIENDS_PROFILE.FACULTY_ID);
        public static final ForeignKey<FriendsProfileRecord, RelationshipStatusRecord> FRIENDS_PROFILE_IBFK_3 = createForeignKey(com.youbc.generated.schema.Keys.KEY_RELATIONSHIP_STATUS_PRIMARY, FriendsProfile.FRIENDS_PROFILE, "friends_profile_ibfk_3", FriendsProfile.FRIENDS_PROFILE.RELATIONSHIP_ID);
        ...
        public static final ForeignKey<FriendsProfileTagsRecord, FriendsTagsRecord> FRIENDS_PROFILE_TAGS_IBFK_2 = createForeignKey(com.youbc.generated.schema.Keys.KEY_FRIENDS_TAGS_PRIMARY, FriendsProfileTags.FRIENDS_PROFILE_TAGS, "friends_profile_tags_ibfk_2", FriendsProfileTags.FRIENDS_PROFILE_TAGS.TAG_ID);
        ...
        public static final ForeignKey<RoommatesProfileRecord, RoommatesLocationsRecord> ROOMMATES_PROFILE_IBFK_2 = createForeignKey(com.youbc.generated.schema.Keys.KEY_ROOMMATES_LOCATIONS_PRIMARY, RoommatesProfile.ROOMMATES_PROFILE, "roommates_profile_ibfk_2", RoommatesProfile.ROOMMATES_PROFILE.LOCATION_ID);
